// Server component. Mesmo padrao do BotaoBaixarOfx (SC-01): quando `bloqueado`,
// e um <span> desabilitado (motivo em `title` e visivel ao lado), nunca um <a>
// que levaria a uma rota que responde 403.
...
export function BotaoBaixarRelatorio({
  href,
  bloqueado,
  motivo,
}: {
